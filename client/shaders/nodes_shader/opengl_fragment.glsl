...
////        alphaC = 1.0;
////    }
//    float relCol = shadowColor.r * alphaC;
//    gl_FragData[0] = vec4(mainColor.rgb * relCol, 1.0);
//    gl_FragData[0] = vec4(mainColor.r, mainColor.g, mainColor.b, 1.0);
//    gl_FragData[0] = vec4(shadowColor.a, shadowColor.a, shadowColor.a, 1.0);
}
